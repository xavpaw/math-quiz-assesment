...
while True:
    try:
        difficulty = int_check("Enter the difficulty level (1 / easy, 2 / medium, or 3 / hard): ", 1, 3)
        break
    except ValueError:
...
try:
    for _ in range(20):  # Assuming you have 20 questions
        ...
        history_feedback = f"Question: {question} | Your answer: {answer} | Correct answer: {result} | {'Correct' if answer == result else 'Incorrect'}"
